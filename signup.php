 ...
 <?php   
  ...
  if (isset($_POST['userid']))
  {
    ...
    else
    {
        ...
        $result = queryMysql("SELECT * FROM USERS WHERE USERNAME='$userid'");
        ...
        else if($repass == $password)
        {
            ...
            else
            {
                ...
                $per="USER";
                queryMysql("INSERT INTO USERS  VALUES('$userid', '$password','$per')");
...
?>
                    <form method='POST' action='signup.php' class="form-signin"> 
                        <span>Username:</span>
                       <input type='text' id="us" onkeyup="spacea()" onBlur='checkUser(this.value)' maxlength='30' name='userid'   placeholder='<?php echo "$unfield"; ?>' required autofocus/><span id='info'></span>
                        <br>
