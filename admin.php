                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="#"><i class="fa fa-fw fa-bar-chart-o"></i>In Progress</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-fw fa-tasks"></i>Interview</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-fw fa-check"></i>Approved</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-fw fa-times-circle"></i>Decline</a>
                            </li>
