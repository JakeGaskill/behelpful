...
<body>
    ...
    <div id="wrapper2">
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" >
                            ...
                            <li class= "activesli">
                                <a href="interview.php" class = "sli"><i class="fa fa-fw fa-tasks"></i>Interview</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper5">
                        ...
                        <h1 class="recent">Interview Required Volunteer Work</h1>
            
                <div>
               <?php echo interview($connection); ?> 
