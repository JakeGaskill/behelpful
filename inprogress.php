...
<body>
    ...
    <div id="wrapper2">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li >
                        ...
                        <ul id="demo" >
                            <li class = "activesli">
                                <a href="inprogress.php" class = "sli"><i class="fa fa-fw fa-bar-chart-o"></i>In Progress</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper5">
            ...
            <h1 class="recent">Pending Volunteer Work</h1>
            
                <div>
               <?php echo inprogress($connection); ?> 
